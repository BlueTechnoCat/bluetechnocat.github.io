...
btn.addEventListener("click", () => {
    ...
    if (ovr.checked) {
        if (drop.value == "Z") {
            res.innerHTML = "Z1: " + Math.ceil(divide(zx1.value, 8)) + "<br /><br />Z2: " + Math.floor(divide(zx1.value, 8)) + "<br /><br />X: " + divide(xz.value, 8);
        }
        else {
            res.innerHTML = "X1: " + Math.ceil(divide(zx1.value, 8)) + "<br /><br />X2: " + Math.floor(divide(zx1.value, 8)) + "<br /><br />Z: " + divide(xz.value, 8);
        }
    }
    else {
        if (drop.value == "Z") {
